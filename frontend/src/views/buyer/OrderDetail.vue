...
import { getOrders, confirmReceipt, updateOrder, fetchListings, getDisputes, getDisputesByOrder } from '../../services/api.js'
...
async function handleConfirmReceipt() {
  ...
  try {
    ...
    order.value = result?.data?.order || order.value
